...
| Windows 11 | Visual Studio 2022 or VS 2022 Build Tools with the **Desktop development with C++** workload. CMake is handled for you by `build.bat` — see **Windows 11** below. |
